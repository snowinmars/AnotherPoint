...
namespace AnotherPoint.Core
{
	public class ClassCore : IClassCore
	{
		...
		public Class Map(Type type)
		{
			...
			TryToResolveNameAndPurpose(type, @class);

			SetupEndpoint(type, @class);
			SetupGeneric(type, @class.Type);

			SetupConstants(type.GetConstants(), @class.Constants);
			SetupNamespaces(type.GetCustomAttributes<InsertUsingAttribute>(), @class.Usings);
